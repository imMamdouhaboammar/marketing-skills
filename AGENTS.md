...
This repository contains **Agent Skills** for AI agents following the [Agent Skills specification](https://agentskills.io/specification.md). Skills install to `.agents/skills/` (the cross-agent standard). This repo also serves as a **Claude Code & Codex plugin marketplace** via `.claude-plugin/marketplace.json` and `.codex-plugin/marketplace.json`.
...
├── CONTRIBUTING.md
├── LICENSE
├── NEURAL_SYSTEM.md       # Neural Connection System Architecture
└── README.md
```
